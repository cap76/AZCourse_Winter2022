...
Excercise 2.3: The same sippet of code should be usable from the image analyses, with minor changes to "image size". We first randomly set a certain fraction of pixels to 0.
