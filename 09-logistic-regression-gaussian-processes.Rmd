...
```{r bot, echo = F, fig.cap = 'Botrytis infection of Arabidopsis over a 48 hour window', fig.align = 'center', fig.show='hold', out.width = '90%'}
knitr::include_graphics(c("images/botrytis.png"))
```
...
```{r embryo, echo = F, fig.cap = '3D representations of primate embryos at Carnegie stages 5, 6, and 7. Laser capture microdissection allowed comprehesnive RNA-sequencing at near single cell level whislt retaining 3D-sptial information', fig.align = 'center', fig.show='hold', out.width = '90%'}
knitr::include_graphics(c("images/embryo.png"))
```
...
p <- plot_ly(x = D1$V1, y = D1$V2, z = D1$V3,  
             ...
             opacity =0.9,
             type = "mesh3d") %>% layout(scene = list(xaxis = ax, yaxis = ax, zaxis = ax), font = list(color='#FFFFFF'))
p <- p %>% add_trace(data=D5, x=D5$X[ind1],y=D5$Y[ind1],z=D5$Z[ind1],type="scatter3d", type   = 'scatter', mode   = 'markers', opacity =0.9, marker = list(size = 5))
p
```
